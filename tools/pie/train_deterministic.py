...
def main(args):
    ...
    #concat_dataset = torch.utils.data.dataset.ConcatDataset([train_gen, val_gen])
    #train_val = torch.utils.data.DataLoader(dataset=concat_dataset, batch_size=128, shuffle=True)
