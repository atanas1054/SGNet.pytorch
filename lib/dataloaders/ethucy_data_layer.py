...
class ETHUCYDataLayer(data.Dataset):
    ...
    def __init__(self, args, split):
        ...
        args.target = args.target_dataset.lower()
        ...
        if split == 'train':
            ...
            f = open(os.path.join(args.eth_root, args.target, 'val', args.target+'_val.pkl'), 'rb')
        elif split == 'test':
            f = open(os.path.join(args.eth_root, args.target, 'test', args.target+'_test.pkl'), 'rb')
        else:
            raise ValueError()
